...
/// <summary>
/// Provides programmatic access to <see cref="InputActionAsset" />, <see cref="InputActionMap" />, <see cref="InputAction" /> and <see cref="InputControlScheme" /> instances defined in asset "Assets/ResourcesStatic/Inputs/BaseActions.inputactions".
/// </summary>
/// <remarks>
...
public partial class @BaseActions: IInputActionCollection2, IDisposable
{
    ...
    ~@BaseActions()
    {
        UnityEngine.Debug.Assert(!m_Gameplay.enabled, "This will cause a leak and performance issues, BaseActions.Gameplay.Disable() has not been called.");
    }
