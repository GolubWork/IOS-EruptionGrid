...
public partial class GameEntity {
    ...
    public Code.Gameplay.Statuses.TimeLeft timeLeft { get { return (Code.Gameplay.Statuses.TimeLeft)GetComponent(GameComponentsLookup.TimeLeft); } }
    ...
    public GameEntity AddTimeLeft(float newValue) {
        ...
        var component = (Code.Gameplay.Statuses.TimeLeft)CreateComponent(index, typeof(Code.Gameplay.Statuses.TimeLeft));
