...
public partial class GameEntity {
    ...
    public Code.Gameplay.Movement.Speed speed { get { return (Code.Gameplay.Movement.Speed)GetComponent(GameComponentsLookup.Speed); } }
    ...
    public GameEntity AddSpeed(float newValue) {
        ...
        var component = (Code.Gameplay.Movement.Speed)CreateComponent(index, typeof(Code.Gameplay.Movement.Speed));
