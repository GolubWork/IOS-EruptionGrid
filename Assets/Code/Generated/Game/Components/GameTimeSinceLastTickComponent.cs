...
public partial class GameEntity {
    ...
    public Code.Gameplay.Statuses.TimeSinceLastTick timeSinceLastTick { get { return (Code.Gameplay.Statuses.TimeSinceLastTick)GetComponent(GameComponentsLookup.TimeSinceLastTick); } }
    ...
    public GameEntity AddTimeSinceLastTick(float newValue) {
        ...
        var component = (Code.Gameplay.Statuses.TimeSinceLastTick)CreateComponent(index, typeof(Code.Gameplay.Statuses.TimeSinceLastTick));
