...
public partial class GameEntity {
    ...
    public Code.Gameplay.Statuses.Duration duration { get { return (Code.Gameplay.Statuses.Duration)GetComponent(GameComponentsLookup.Duration); } }
    ...
    public GameEntity AddDuration(float newValue) {
        ...
        var component = (Code.Gameplay.Statuses.Duration)CreateComponent(index, typeof(Code.Gameplay.Statuses.Duration));
