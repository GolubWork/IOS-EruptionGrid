...
public partial class GameEntity {
    ...
    public Code.Gameplay.Armaments.TargetLimit targetLimit { get { return (Code.Gameplay.Armaments.TargetLimit)GetComponent(GameComponentsLookup.TargetLimit); } }
    ...
    public GameEntity AddTargetLimit(int newValue) {
        ...
        var component = (Code.Gameplay.Armaments.TargetLimit)CreateComponent(index, typeof(Code.Gameplay.Armaments.TargetLimit));
