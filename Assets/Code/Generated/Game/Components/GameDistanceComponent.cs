...
public partial class GameEntity {
    ...
    public Code.ConveyourBeltItem.Distance distance { get { return (Code.ConveyourBeltItem.Distance)GetComponent(GameComponentsLookup.Distance); } }
    ...
    public GameEntity AddDistance(float newValue) {
        ...
        var component = (Code.ConveyourBeltItem.Distance)CreateComponent(index, typeof(Code.ConveyourBeltItem.Distance));
