...
public partial class GameEntity {
    ...
    public Code.Gameplay.Abilities.ParentAbility parentAbility { get { return (Code.Gameplay.Abilities.ParentAbility)GetComponent(GameComponentsLookup.ParentAbility); } }
    public Code.Gameplay.Abilities.AbilityId ParentAbility { get { return parentAbility.Value; } }
    public bool hasParentAbility { get { return HasComponent(GameComponentsLookup.ParentAbility); } }

    public GameEntity AddParentAbility(Code.Gameplay.Abilities.AbilityId newValue) {
        var index = GameComponentsLookup.ParentAbility;
        var component = (Code.Gameplay.Abilities.ParentAbility)CreateComponent(index, typeof(Code.Gameplay.Abilities.ParentAbility));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceParentAbility(Code.Gameplay.Abilities.AbilityId newValue) {
        var index = GameComponentsLookup.ParentAbility;
        var component = (Code.Gameplay.Abilities.ParentAbility)CreateComponent(index, typeof(Code.Gameplay.Abilities.ParentAbility));
        component.Value = newValue;
