...
public partial class GameEntity {
    ...
    public Code.Gameplay.Statuses.Period period { get { return (Code.Gameplay.Statuses.Period)GetComponent(GameComponentsLookup.Period); } }
    ...
    public GameEntity AddPeriod(float newValue) {
        ...
        var component = (Code.Gameplay.Statuses.Period)CreateComponent(index, typeof(Code.Gameplay.Statuses.Period));
