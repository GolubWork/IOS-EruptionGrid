...
public partial class Contexts : Entitas.IContexts {
    ...
    public Entitas.IContext[] allContexts { get { return new Entitas.IContext [] { audio, game, input, meta }; } }
...
public partial class Contexts {
    ...
    public void InitializeEntityIndices() {
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, int>(
            ...
            (e, c) => ((Code.Gameplay.Statuses.ApplierStatusLink)c).Value));
        ...
        audio.AddEntityIndex(new Entitas.PrimaryEntityIndex<AudioEntity, int>(
            Id,
            audio.GetGroup(AudioMatcher.Id),
            (e, c) => ((Code.Gameplay.Common.Id)c).Value));
        ...
        game.AddEntityIndex(new Entitas.EntityIndex<GameEntity, Code.Gameplay.Abilities.AbilityId>(
            ParentAbility,
            game.GetGroup(GameMatcher.ParentAbility),
            (e, c) => ((Code.Gameplay.Abilities.ParentAbility)c).Value));
    }
}
...
public static class ContextsExtensions {
    ...
    public static AudioEntity GetEntityWithId(this AudioContext context, int Value) {
        return ((Entitas.PrimaryEntityIndex<AudioEntity, int>)context.GetEntityIndex(Contexts.Id)).GetEntity(Value);
    }
    ...
    public static System.Collections.Generic.HashSet<GameEntity> GetEntitiesWithParentAbility(this GameContext context, Code.Gameplay.Abilities.AbilityId Value) {
        return ((Entitas.EntityIndex<GameEntity, Code.Gameplay.Abilities.AbilityId>)context.GetEntityIndex(Contexts.ParentAbility)).GetEntities(Value);
    }
}
//------------------------------------------------------------------------------
// <auto-generated>
