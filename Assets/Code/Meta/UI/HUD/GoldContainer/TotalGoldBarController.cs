...
{
    public class TotalGoldBarController: UpdatableWindow
    {
        ...
        {
            _currencyBarService.SetTotalCurrencyBar(this);
        }
        public void SetMaxGold(float value)
        {
            goldText.text = _model.SetGold(value);
        }
        protected override void Cleanup()
        {
            _currencyBarService.SetTotalCurrencyBar(null);
