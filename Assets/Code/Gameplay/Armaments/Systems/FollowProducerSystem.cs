...
namespace Code.Gameplay.Armaments.Systems
{
    public class FollowProducerSystem : IExecuteSystem
    {
        ...
        public FollowProducerSystem(GameContext contextParameter)
        {
            _followers = contextParameter.GetGroup(GameMatcher.AllOf(
                GameMatcher.FollowingProducer,
                GameMatcher.WorldPosition,
                GameMatcher.ProducerId
            ));

            _producers = contextParameter.GetGroup(GameMatcher.AllOf(
                GameMatcher.Id,
                GameMatcher.WorldPosition
            ));
        }
